...
namespace EditorExtensions
{
    public class GUIAPI
    {
        ...
        private Rect mTogglesRect = new Rect(20, 330, 200, 20);
        ...
        private Rect mGroupRect = new Rect(20, 630, 20, 100);
        ...
        public void Draw()
        {
            mSrollPos = GUI.BeginScrollView(new Rect(20, 0, 400, 400),mSrollPos, new Rect(0, 0, 400, 600));
            ...
            mTogglesValue = GUI.Toggle(mTogglesRect, mTogglesValue, "Toggle");
            ...
            GUILayout.Window(10000, mWindowRect, (mBoxRect) =>
            {
