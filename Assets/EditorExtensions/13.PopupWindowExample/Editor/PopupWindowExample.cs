...
namespace EditorExtensions
{
    ...
    {
        [MenuItem("EditorExtensions/09.PopupWindowExample")]
        static void Open()
        {
        ...
        private void OnGUI()
        {
            ...
            {
                PopupWindow.Show(mButtonRect, new PopUpdaWindowContentExample());
            }
        ...
        public class  PopUpdaWindowContentExample : PopupWindowContent
        {
            ...
            {
                GUILayout.Label("Hello World PopupWindowContent", EditorStyles.boldLabel);
