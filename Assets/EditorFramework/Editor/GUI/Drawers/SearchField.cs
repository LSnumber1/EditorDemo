...
namespace EditorFramework
{
    public class SearchField : GUIBase
    {
        ...
        public SearchField(string searchContent, string[] searchableContents, int contentIndex)
        {
            ...
            mDrawAPI = typeof(EditorGUI).GetMethod("ToolbarSearchField", BindingFlags.NonPublic | BindingFlags.Static,
                null, new Type[]
                {
                    typeof(int),
                    typeof(Rect),
        ...
        public override void OnGUI(Rect position)
        {
            ...
            if (mDrawAPI != null)
            {
                ...
                string newSearchContent = (string)mDrawAPI.Invoke(null, args) as string;
                ...
                ;
                if (e.keyCode == KeyCode.Return || e.keyCode == KeyCode.Space || e.character == '\n')
                {
